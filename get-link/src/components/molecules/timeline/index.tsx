 ...
 */}
      ...
      <div className='border-b border-white/5'>
        <div className='text-center text-white mx-auto max-w-[1255px] py-10 px-12'>
          <h1 className='text-4xl font-bold'>TimeLine</h1>
          <p className='w-full md:w-[346px] mx-auto pt-3'>
          ...
          <div className='flex flex-col items-start md:items-center mt-[56px] md:mt-[91px]'>
            <div className='flex w-full justify-start md:justify-center relative mt-7'>
              <div className='flex flex-col items-center relative'>
                ...
                <h2 className='text-left text-[#D434FE] text-[12px] md:text-[24px] absolute  w-[159px] md:w-[236px] left-[36px] md:left-[123px] bottom-0'>
                  November 18, 2023
                </h2>
              </div>
              <div className='text-left absolute left-[36px] right-0 md:left-auto md:right-[calc(50%+86px)] md:w-[calc(50%-86px)] md:bottom-[4px]'>
                <h2 className='text-[#D434FE] text-[12px] md:text-[24px]  md:text-right'>
            ...
            <div className='flex w-full justify-start md:justify-center relative mt-7'>
              <div className='flex flex-col items-center relative'>
                ...
                <h2 className='text-left text-[#D434FE] text-[12px] md:text-[24px] absolute  w-[159px] md:w-[236px] left-[36px] md:left-auto md:right-[98px] bottom-0'>
                  November 18, 2023
                </h2>
              </div>
              <div className='text-left absolute left-[36px]  md:left-[calc(50%+98px)] right-0 md:w-[calc(50%-98px)] md:bottom-[-20px]'>
                <h2 className='text-[#D434FE] text-[12px] md:text-[24px] '>
